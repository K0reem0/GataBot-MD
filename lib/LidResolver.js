...
class LidResolver {
  ...
  // ✅ استثناء مخصص
  if (
    lidJid === "236979702779973@s.whatsapp.net" ||
    lidJid === "236979702779973@lid"
  ) {
    return "967779416950@s.whatsapp.net";
  }
  ...
  try {
    ...
    // ✅ استثناء للمرسل
    if (
      processedMessage.key?.participant === "236979702779973@lid" ||
      processedMessage.key?.participant === "236979702779973@s.whatsapp.net"
    ) {
      processedMessage.key.participant = "967779416950@s.whatsapp.net";
    }
      ...
      for (const msgType of messageTypes) {
        ...
        if (msgContent?.contextInfo?.mentionedJid) {
          msgContent.contextInfo.mentionedJid =
            msgContent.contextInfo.mentionedJid.map(jid =>
              jid === "236979702779973@lid" || jid === "236979702779973@s.whatsapp.net"
                ? "967779416950@s.whatsapp.net"
                : jid
            );
        }
      }
